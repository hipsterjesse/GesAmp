...
public class MusicSettings extends AppCompatActivity {
        ...
        ListViewFolders.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (new File(currentFilePath + "/" + FoldersAdapter.getItem(position)).isFile()) {
                    Toast.makeText(MusicSettings.this, "Das ist kein Ordner", Toast.LENGTH_LONG).show();
                } else {
    ...
    public void ButtonBack_Click(View view) {
        if (currentFilePath.getParent() != null) {
            ...
            Toast.makeText(MusicSettings.this, "Dieser Ordner hat keinen Überordner", Toast.LENGTH_LONG).show();
        }
    }
    ...
    public void showFiles() {
        ...
        if (!currentFilePath.canRead()) {
            Toast.makeText(MusicSettings.this, "Keine Leserechte", Toast.LENGTH_LONG).show();
        }
        ...
        FoldersAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_2, android.R.id.text1, folder);
        ListViewFolders.setAdapter(FoldersAdapter);
    }

    public void button_SelectFolder_Click(View view) {
        boolean musicFileInList = false;
        for (String fileName : folder) {
            if (fileName.contains(".")) { //Überprüfen ob Music File
                musicFileInList = true;
            }
        }
        if (musicFileInList) {
            ...
            Toast.makeText(MusicSettings.this, "Keine Musik Files", Toast.LENGTH_LONG).show();
        }
